...
while True:
    ...
    if game.run == True:
        game_screen.blit(level_msg, (570, 740, 50, 50))
    else:
        game_screen.blit(credit_msg, (400, 740, 50, 50))

    x = 50
    spaceship_life = pygame.image.load("Graphic/spaceship_life.png").convert_alpha()
    for life in range(game.live_remain):
        game_screen.blit(spaceship_life, (x, 745))
        x += 50

    game_screen.blit(score_msg, (50, 15, 50, 50))
    game_screen.blit(highscore_msg, (540, 15, 50, 50))
    ...
    game_screen.blit(score_surface, (50, 40, 50, 50))
    game_screen.blit(highscore_surface, (610, 40, 50, 50))
    ...
    if game.run == False:
        if game.blink_effect() == True:
            game_screen.blit(game.game_over_img,((SCREEN_WIDTH - 400)/2 + 20, (SCREEN_HEIGHT - 400)/2))
            game_screen.blit(game.restart_button.image,((SCREEN_WIDTH - 120)/2 + 20, SCREEN_HEIGHT - 250))
